...
export class ProjectService{
    private projects: Project[] = [
        new Project('Join', 'Join is a Kanban Project Management Tool, like Trello, Join is a Kanban Project Management Tool, like Trello', ['JavaScript', 'HTML', 'CSS'], "https://github.com/SchrimpsMitReis/Join---Kanban-Webapp"),
